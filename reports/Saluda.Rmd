---
title: "Water Withdrawal Report for the Saluda Basin (2022)"
...
# load(here::here("data", "wu.rda"))
# load(here::here("data", "intakes.rda"))
...
#36IR009G05 monthly wu (MG) is 0.2 not 20
#36IR009G06 monthly wu (MG) is 0.25 not 25
mutate(T1 = case_when(
                         T1 < 10 ~ NA,
                         T1 >= 10 & T1 < 33 ~ T1,
                         T1 >= 30 ~ 33)
...
wu_monit_dat2 <- wu_monit_dat %>%
  ...
  dplyr::mutate(total= case_when(sourceid=="36IR009G05" & year ==2018, ~2.4))
                
                
                jan:dec = ifelse(sourceid=="36IR009G06"& year ==2018,0.25, jan:dec)) %>%
...
```{r combine-bar-plots-noPH, fig.cap= paste0('\\textbf{Figure 2.} ',y,' Water withdrawals excluding Hydroelectric Power in the ',req_basin, ' basin by category and source. Groundwater \\textbf{(A)}, Surface Water \\textbf{(B)}, and Total \\textbf{(C)}.'), fig.align="center", echo=FALSE, fig.width=12,fig.height=10, fig.path='Saluda_figures/', dev='png'}
...
```{r trend-TH_bar-plot,fig.cap= paste0('\\textbf{Figure A3.} Annual surface water withdrawals in the ',req_basin,' for Thermoelectric Power.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=4, fig.path='Saluda_figures/', dev='png'}
...
```{r trend-WS_bar-plot,fig.cap= paste0('\\textbf{Figure A4.} Annual water withdrawals in the ',req_basin, ' basin for Water Supply by source. Groundwater (GW) \\textbf{(A)}, Surface Water (SW) \\textbf{(B)}, and Total \\textbf {(C)}.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=11, fig.path='Saluda_figures/', dev='png'}
...
```{r trend-IN_bar-plot,fig.cap= paste0('\\textbf{Figure A5.} Annual water withdrawals in the ',req_basin, ' basin for Industry by source. Groundwater (GW) \\textbf{(A)}, Surface Water (SW) \\textbf{(B)}, and Total \\textbf {(C)}.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=11, fig.path='Saluda_figures/', dev='png'}
...
```{r trend-Ag_bar-plot,fig.cap= paste0('\\textbf{Figure A6.} Annual water withdrawals in the ',req_basin, ' basin for Agriculture by source. Groundwater (GW) \\textbf{(A)}, Surface Water (SW) \\textbf{(B)}, and Total \\textbf {(C)}.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=11, fig.path='Saluda_figures/', dev='png'}
...
```{r trend-GC_bar-plot,fig.cap= paste0('\\textbf{Figure A7.} Annual water withdrawals in the ',req_basin, ' basin for Golf Course by source. Groundwater (GW) \\textbf{(A)}, Surface Water (SW) \\textbf{(B)}, and Total \\textbf {(C)}.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=11, fig.path='Saluda_figures/', dev='png'}
...
```{r trend-MI_bar-plot,fig.cap= paste0('\\textbf{Figure A8.} Annual surface water (SW) withdrawals in the ',req_basin, ' basin for Mining.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=4, fig.path='Saluda_figures/', dev='png'}

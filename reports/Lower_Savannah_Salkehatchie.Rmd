---
title: "Water Withdrawal Report for the Lower Savannah-Salkehatchie Basin (2022)"
...
source(here("R","other-important.R"))

y <- 2022
req_basin <- "Lower Savannah-Salkehatchie"
...
wu_monit_dat <- scwaterwithdrawal::wu$WU_monit %>%
  dplyr::filter(year > 2001)

# load intakes.rda 
intakes_edit <- scwaterwithdrawal::intakes %>%
...
```{r LSS-map, fig.cap= paste0('\\textbf{Figure 1.} Major river basins in South Carolina, highlighting the ',req_basin,' basin.'), fig.width= 7, fig.height=5, echo=FALSE}
...
```{r combine-bar-plots-noPH, fig.cap= paste0('\\textbf{Figure 2.} ',y,' Water withdrawals excluding Hydroelectric Power in the ',req_basin, ' basin by category and source. Groundwater \\textbf{(A)}, Surface Water \\textbf{(B)}, and Total \\textbf{(C)}.'), fig.align="center", echo=FALSE, fig.width=12,fig.height=10, fig.path='LSS_figures/', dev='png'}
...
no_power_basinwise_wu_source <- wu_monit_dat2 %>% 
  dplyr::filter(year== y & category %nin% c("Hydro Power", "Thermal Power", "Nuclear Power")) %>%
  dplyr::group_by(basin,water_source_code) %>%
  dplyr::summarise(total_mgd = sum(total_mgd)) %>%
  tidyr::spread(water_source_code, total_mgd) %>%
  dplyr::rename(Groundwater = G,
...
```{r combine-bar-plots-nopower, fig.cap= paste0('\\textbf{Figure 3.} ',y, ' Water withdrawals excluding Hydroelectric and Thermoelectric Power in the ', req_basin, ' basin by category and source, Groundwater \\textbf{(A)}, Surface Water \\textbf{(B)}, and Total \\textbf{(C)}.'), fig.align="center", echo=FALSE, fig.width=12,fig.height=9,fig.path='LSS_figures/', dev='png'}
...
```{r trend-TH_bar-plot,fig.cap= paste0('\\textbf{Figure A3.} Annual water withdrawals in the ',req_basin,' for Thermoelectric Power by source. Groundwater (GW) \\textbf{(A)}, Surface Water (SW) \\textbf{(B)}, and Total \\textbf {(C)}.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=11, fig.path='LSS_figures/', dev='png'}
...
basin_TH_plot_2011_2022  <- trend_plot(dat=basin_TH_summary_2011_2022 , x_col="year", y_col="Total")+
  geom_bar(stat = "identity", fill = "black", width = 50)+
  ylab("Total Withdrawals (MGD)")
...
basin_TH_GW_plot_2011_2022  <- trend_plot(dat=basin_TH_summary_2011_2022 , x_col="year", y_col="G")+
  geom_bar(stat = "identity", fill = "springgreen3", width = 50)+
  ylab("GW Withdrawals (MGD)")

ggarrange(basin_TH_GW_plot_2011_2022 ,basin_TH_SW_plot_2011_2022 ,basin_TH_plot_2011_2022 ,ncol=1, nrow = 3, labels = c("A","B", "C"), widths = c(5,5,5), heights = c(5,5,5), font.label=list(color="black",size=15))
grid::grid.rect(gp = gpar(col = "black", fill = NA))
...
```{r trend-WS_bar-plot,fig.cap= paste0('\\textbf{Figure A4.} Annual water withdrawals in the ',req_basin, ' basin for Water Supply by source. Groundwater (GW) \\textbf{(A)}, Surface Water (SW) \\textbf{(B)}, and Total \\textbf {(C)}.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=11, fig.path='LSS_figures/', dev='png'}
...
```{r trend-IN_bar-plot,fig.cap= paste0('\\textbf{Figure A5.} Annual water withdrawals in the ',req_basin, ' basin for Industry by source. Groundwater (GW) \\textbf{(A)}, Surface Water (SW) \\textbf{(B)}, and Total \\textbf {(C)}.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=11, fig.path='LSS_figures/', dev='png'}
...
basin_IN_plot_2011_2022  <- trend_plot(dat=basin_IN_summary_2011_2022 , x_col="year", y_col="Total")+
  geom_bar(stat = "identity", fill = "black", width = 50)+
  ylab("Total Withdrawals (MGD)")
...
basin_IN_GW_plot_2011_2022  <- trend_plot(dat=basin_IN_summary_2011_2022 , x_col="year", y_col="G")+
  geom_bar(stat = "identity", fill = "springgreen3", width = 50)+
  ylab("GW Withdrawals (MGD)")

ggarrange(basin_IN_GW_plot_2011_2022 ,basin_IN_SW_plot_2011_2022 ,basin_IN_plot_2011_2022 ,ncol=1, nrow = 3, labels = c("A","B", "C"), widths = c(5,5,5), heights = c(5,5,5), font.label=list(color="black",size=15))
grid::grid.rect(gp = gpar(col = "black", fill = NA))
...
```{r trend-Ag_bar-plot,fig.cap= paste0('\\textbf{Figure A6.} Annual water withdrawals in the ',req_basin, ' basin for Agriculture by source. Groundwater (GW) \\textbf{(A)}, Surface Water (SW) \\textbf{(B)}, and Total \\textbf {(C)}.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=11, fig.path='LSS_figures/', dev='png'}
...
```{r trend-GC_bar-plot,fig.cap= paste0('\\textbf{Figure A7.} Annual water withdrawals in the ',req_basin, ' basin for Golf Course by source. Groundwater (GW) \\textbf{(A)}, Surface Water (SW) \\textbf{(B)}, and Total \\textbf {(C)}.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=11, fig.path='LSS_figures/', dev='png'}
...
```{r trend-MI_bar-plot,fig.cap= paste0('\\textbf{Figure A8.} Annual groundwater (GW) withdrawals in the ',req_basin, ' basin for Mining.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=4, fig.path='LSS_figures/', dev='png'}
...
basin_MI_GW_plot_2011_2022 <- trend_plot(dat=basin_MI_summary_2011_2022 , x_col="year", y_col="G")+
  geom_bar(stat = "identity", fill = "springgreen3", width = 50)+
  ylab("GW Withdrawals (MGD)")

basin_MI_GW_plot_2011_2022

```

## A.10 Water Withdrawal for Aquaculture

```{r trend-AQ_bar-plot,fig.cap= paste0('\\textbf{Figure A9.} Annual water withdrawals in the ',req_basin, ' basin for Aquaculture by source. Groundwater (GW) \\textbf{(A)}, Surface Water (SW) \\textbf{(B)}, and Total \\textbf {(C)}.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=11, fig.path='LSS_figures/', dev='png'}

basin_AQ_summary_2011_2022  <- trend_plot_summary(water_use_data = wu_monit_dat2,trend_year=trend_year1, which_basin=req_basin ,req_category = "Aquaculture")%>%
  dplyr::mutate(year = lubridate::ymd(year, truncated = 2L))

basin_AQ_plot_2011_2022  <- trend_plot(dat=basin_AQ_summary_2011_2022 , x_col="year", y_col="Total")+
  geom_bar(stat = "identity", fill = "black", width = 50)+
  ylab("Total Withdrawals (MGD)")

basin_AQ_SW_plot_2011_2022  <- trend_plot(dat=basin_AQ_summary_2011_2022 , x_col="year", y_col="S")+
  geom_bar(stat = "identity", fill = "steelblue3", width = 50)+
  ylab("SW Withdrawals (MGD)")

basin_AQ_GW_plot_2011_2022  <- trend_plot(dat=basin_AQ_summary_2011_2022 , x_col="year", y_col="G")+
  geom_bar(stat = "identity", fill = "springgreen3", width = 50)+
  ylab("GW Withdrawals (MGD)")

ggarrange(basin_AQ_GW_plot_2011_2022 ,basin_AQ_SW_plot_2011_2022 ,basin_AQ_plot_2011_2022,ncol=1, nrow = 3, labels = c("A","B", "C"), widths = c(5,5,5), heights = c(5,5,5), font.label=list(color="black",size=15))
grid::grid.rect(gp = gpar(col = "black", fill = NA))

```

## A.11 Water Withdrawal for Other

```{r trend-OT_bar-plot,fig.cap= paste0('\\textbf{Figure A10.} Annual groundwater (GW) withdrawals in the ',req_basin, ' basin for Other category.'), fig.align="center", echo=FALSE, fig.width=10, fig.height=4, fig.path='LSS_figures/', dev='png'}

basin_OT_summary_2011_2022 <- trend_plot_summary(water_use_data = wu_monit_dat2,trend_year=trend_year1, which_basin=req_basin, req_category = "Other")%>%
  dplyr::mutate(year = lubridate::ymd(year, truncated = 2L)) %>% 
  replace(is.na(.), 0) # without the replace NA with 0 statement, it only plots 
# for the available data years. This is a fix to include all years on the x-axis. 

basin_OT_GW_plot_2011_2022 <- trend_plot(dat=basin_OT_summary_2011_2022 , x_col="year", y_col="G")+
  geom_bar(stat = "identity", fill = "steelblue3", width = 50)+
  ylab("Total Withdrawals (MGD)")

basin_OT_GW_plot_2011_2022
